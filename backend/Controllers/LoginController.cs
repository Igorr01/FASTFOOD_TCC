...
namespace Backend.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<Models.Response.FastFoodResponse.Login> Logar(Models.Request.FastFoodRequest.Login request)
        {
            try
            {
        ...
        [HttpPost("Criarlogin")]
        public ActionResult<Models.Response.FastFoodResponse.Cadastro> CadastrarLogin(Models.Request.FastFoodRequest.Cadastro request)
        {
            try
            {
